...
export default function Home() {
  ...
  return (
    <main id="home" className="gradient-bg min-h-screen">
      {/* Navbar */}
      <nav className="fixed top-0 w-full z-50 px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center glass rounded-2xl px-6 py-3">
          <Link href="/#home" className="flex items-center gap-2 font-bold text-lg hover:opacity-90 transition-opacity">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#download" className="bg-white text-slate-950 px-4 py-2 rounded-xl text-sm font-bold hover:bg-slate-200 transition-all">
              Télécharger
            </a>
          </div>
        </div>
